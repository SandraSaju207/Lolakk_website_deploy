...
const [showFilters, setShowFilters] = useState(false);
  ...
  p.type?.toLowerCase().trim() === "bracelets"
);
...
const filteredItems = products.filter((item) => {
  ...
  return (
    ...
    (filters.materialType === "all" ||
      item.materialType?.toLowerCase() === filters.materialType) &&
...
{isFiltered && (
  <button
    ...
    className="flex items-center gap-2 text-[10px] uppercase tracking-widest text-red-400/80 hover:text-red-400 transition-all border-b border-red-400/20 pb-1 mt-4"
  >
    <svg
