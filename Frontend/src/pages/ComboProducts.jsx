...
<div className="text-center mb-6">
  <h1 className="text-4xl text-amber-400"> Combo Collection</h1>
...
/>
 ...
 {item.description || "Premium luxury combo jewellery set"}
</p>
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-400 leading-relaxed mt-6 text-sm md:text-base">
                  {selectedProduct.description ||
                   "A premium jewellery combo set featuring perfectly matched accessories for a complete luxurious look."}
                </p>
