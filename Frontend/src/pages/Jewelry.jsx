...
export default function JewelryExperience() {
  ...
  return (
    <section id="jewelry" className="h-screen w-full overflow-hidden bg-black text-white relative">
      ...
      >
        {slides.map((slide, i) => (
          <div key={i} className="w-full h-full flex-shrink-0 flex">
            ...
            <div className="w-1/2 h-full flex flex-col justify-center items-center bg-neutral-900">
              <h2 className="font-royal text-4xl md:text-6xl tracking-[0.25em] uppercase mb-8 text-white drop-shadow-[0_2px_10px_rgba(255,215,0,0.3)]">
              {slide.title} 
              </h2> 

              <img
                src={slide.product}
                className="w-[260px] md:w-[380px] object-contain transition duration-700 hover:scale-105"
              />
            </div>
