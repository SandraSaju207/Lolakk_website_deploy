...
<div
  key={i}
  className="w-full h-full flex-shrink-0 flex flex-col md:flex-row"
>            
            {/* LEFT IMAGE */}
<div className="w-full md:w-1/2 h-1/2 md:h-full overflow-hidden">
            ...
            {/* RIGHT CONTENT */}
<div className="w-full md:w-1/2 h-1/2 md:h-full flex flex-col justify-center items-center bg-neutral-900 px-4 text-center">    
